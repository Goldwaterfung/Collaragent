            ...
            <div className="flex items-center justify-between p-3 border-b border-surface-200 bg-surface-50/80 backdrop-blur-sm">
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className={`p-1.5 rounded-md transition-colors cursor-pointer ${showHistory ? 'bg-primary/20 text-primary' : 'hover:bg-surface-200 text-black/60 hover:text-black'}`}
                        title="History"
                    >
                        <HistoryIcon />
                    </button>
                ...
                <div className="flex items-center gap-1">
                    <button
                        ...
                        className="p-1.5 rounded-md hover:bg-surface-200 text-black/60 hover:text-black transition-colors cursor-pointer"
                        title="New Chat"
                    >
                        <PlusIcon />
                    </button>
