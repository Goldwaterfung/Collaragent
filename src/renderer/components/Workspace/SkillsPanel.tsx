...
export function SkillsPanel() {
  const { skills, activeSkillPath, setActiveSkillPath, isLoading, createSkill, deleteSkill } =
    useSkillsContext()
    ...
    <div className="flex flex-col mb-1 relative rounded-lg">
      ...
      >
        <div className="flex items-center gap-2 flex-1 min-w-0">
          ...
          {isLoading && <span className="text-[9px] text-(--ev-c-text-3) italic">loading...</span>}
        </div>
        <button
          onClick={(e) => {
            e.stopPropagation()
