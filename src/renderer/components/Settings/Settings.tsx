...
export const Settings = () => {
    ...
    const [activeTab, setActiveTab] = useState<'general' | 'subagents' | 'skills' | 'tools'>('general');
    ...
    return (
        <div className="settings-container w-full h-full overflow-y-auto bg-surface-50">
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
                <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-6 sm:mb-8 text-black">Settings</h2>
