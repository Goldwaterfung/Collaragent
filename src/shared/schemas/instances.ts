...
export const BlockSchema = z
  .object({
    ...
    listType: ListTypeEnum.optional().describe(
      'The list type (bullet or number) for list-item blocks.'
    ),
  ...
  .refine(
    (b) =>
      ...
      (Array.isArray(b.tableRows) && b.tableRows.length >= 0),
    {
...
export const DocumentSchema = z.object({
  blocks: z
    ...
    .describe('The blocks in the document.'),
...
export const DocumentInstancePayloadSchema = z.union([DocumentSchema, GraphCanvasDTOSchema])
