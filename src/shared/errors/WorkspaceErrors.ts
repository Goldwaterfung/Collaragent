...
export const enum WorkspaceErrorCode {
  ...
  // Comments & Review Subsystem
  WORKSPACE_COMMENT_TARGET_NOT_FOUND = 'WORKSPACE_COMMENT_TARGET_NOT_FOUND',
  WORKSPACE_COMMENT_EMPTY = 'WORKSPACE_COMMENT_EMPTY',
  ...
  WORKSPACE_SNAPSHOT_NOT_FOUND = 'WORKSPACE_SNAPSHOT_NOT_FOUND',
  WORKSPACE_SNAPSHOT_CORRUPTED = 'WORKSPACE_SNAPSHOT_CORRUPTED',
  WORKSPACE_STALE_SEQUENCE = 'WORKSPACE_STALE_SEQUENCE',
  WORKSPACE_GRAPH_INTEGRITY_VIOLATION = 'WORKSPACE_GRAPH_INTEGRITY_VIOLATION',

  // Workspace-as-Wiki & Knowledge Compiler Subsystem
  ...
  WORKSPACE_WIKI_EDGE_NOT_FOUND = 'WORKSPACE_WIKI_EDGE_NOT_FOUND'
}
