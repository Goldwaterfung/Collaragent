...
function mapSharedToLocal(cmd: SharedCanvasCommand): CanvasCommand | null {
  ...
  switch (cmd.type) {
    case 'graph:add_node':
      console.log('[WebSocketSyncPlugin] mapSharedToLocal graph:add_node', {
        nodeId: cmd.nodeId,
    ...
    case 'graph:add_relationship':
      console.log('[WebSocketSyncPlugin] mapSharedToLocal graph:add_relationship', {
        id: cmd.relationshipId,
        from: cmd.relationship.from,
        to: cmd.relationship.to
      })
      return {
...
function mapLocalToShared(cmd: CanvasCommand): SharedCanvasCommand | null {
  ...
  switch (cmd.type) {
    ...
    case 'AddRelationship':
      console.log('[WebSocketSyncPlugin] mapLocalToShared AddRelationship', {
        id: cmd.payload.relationship.id
      })
      return {
    ...
    default:
      console.warn(
        '[CanvasSyncPlugin] Unhandled local command in mapLocalToShared:',
