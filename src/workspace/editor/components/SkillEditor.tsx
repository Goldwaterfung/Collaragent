...
function Placeholder() {
  return (
    <div className="editor-placeholder px-8 py-8 font-mono text-[13px] text-black/50">
    ...
    <div className="flex flex-col h-full bg-white relative">
      ...
      <div className="flex items-center justify-between px-4 py-2 border-b border-surface-200 bg-surface-50">
        <div className="flex items-center gap-2 overflow-hidden">
          <span className="text-[10px] uppercase font-bold text-(--ev-c-text-3) tracking-wider">
            Skill Editor
          </span>
          <span className="text-[10px] font-mono text-(--ev-c-text-3) truncate opacity-60">
            {skillMdPath}
          </span>
        </div>
        {isSaving && (
        ...
        <div className="px-8 pt-6 pb-4">
          <div className="bg-surface-50 border border-surface-200 rounded-lg p-5 space-y-4">
            <div className="flex flex-col gap-1.5">
              <label className="text-[11px] font-bold text-(--ev-c-text-3) uppercase tracking-wider">
                Skill Name
              </label>
              <input
                type="text"
            ...
            {rawContent.extraYaml && (
              <div className="bg-white rounded p-4 font-mono text-[11px] text-black/60 whitespace-pre border border-surface-200 mt-2 shadow-sm relative">
                <span className="absolute top-0 right-0 py-1 px-2 text-[9px] uppercase font-bold text-black/40">
                  Extra YAML
                </span>
                {rawContent.extraYaml}
              </div>
              ...
              <RichTextPlugin
                contentEditable={
                  <ContentEditable
                    ...
                    style={{ outline: 'none', padding: '16px 36px' }}
                  />
                }
