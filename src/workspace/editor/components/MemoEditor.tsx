...
function Placeholder({ text }: { text: string }) {
  return (
    <div className="editor-placeholder absolute top-0 left-0 px-3 py-3 font-mono text-[13px] text-black/50 pointer-events-none">
      {text}
    </div>
  )
}
      ...
      <LexicalComposer initialConfig={config}>
        ...
        >
          <div
            ...
            style={{ outline: 'none', flex: 1, overflowY: 'auto', position: 'relative' }}
          >
            <RichTextPlugin
              contentEditable={
                <ContentEditable
