...
function elementAlignToSchema(formatType: string | null | undefined): Align | undefined {
...
function registerComments(storageIds: readonly string[], registry: CommentRegistry): string[] {
