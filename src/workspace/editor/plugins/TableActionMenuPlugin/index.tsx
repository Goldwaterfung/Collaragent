...
function TableCellActionMenuContainer({
  ...
  const $moveMenu = useCallback(() => {
    ...
    if (enabled) {
      ...
      const top = tableCellRect.top + window.scrollY
      const left = tableCellRect.right + window.scrollX
    ...
    return mergeRegister(
      ...
      editor.registerRootListener((rootElement) => {
        if (rootElement) {
          ...
          delayedCallback()
          return () => rootElement.removeEventListener('pointerup', delayedCallback)
        }
        return undefined
      }),
