...
function BlockOptionsDropdownList({
  ...
  return (
    <div className="dropdown" ref={dropDownRef}>
      <button className="item" onMouseDown={(e) => e.preventDefault()} onClick={formatParagraph}>
        <span className="icon paragraph" />
        <span className="text">Normal</span>
        {blockType === 'paragraph' && <span className="active" />}
      </button>
      <button className="item" onMouseDown={(e) => e.preventDefault()} onClick={formatLargeHeading}>
        <span className="icon h1" />
        <span className="text">Page Title</span>
        {blockType === 'h1' && <span className="active" />}
      </button>
      <button className="item" onMouseDown={(e) => e.preventDefault()} onClick={formatSmallHeading}>
        <span className="icon h2" />
        <span className="text">Heading</span>
        {blockType === 'h2' && <span className="active" />}
      </button>
      <button className="item" onMouseDown={(e) => e.preventDefault()} onClick={formatSubHeading}>
        <span className="icon h3" />
        <span className="text">Sub-Heading</span>
        {blockType === 'h3' && <span className="active" />}
      </button>
      <button className="item" onMouseDown={(e) => e.preventDefault()} onClick={formatH4}>
        <span className="icon h4" />
        <span className="text">H4 Heading</span>
        {blockType === 'h4' && <span className="active" />}
      </button>
      <button className="item" onMouseDown={(e) => e.preventDefault()} onClick={formatBulletList}>
        <span className="icon bullet-list" />
        <span className="text">Bullet List</span>
        {blockType === 'ul' && <span className="active" />}
      </button>
      <button className="item" onMouseDown={(e) => e.preventDefault()} onClick={formatNumberedList}>
        <span className="icon numbered-list" />
        <span className="text">Numbered List</span>
        {blockType === 'ol' && <span className="active" />}
      </button>
      <button className="item" onMouseDown={(e) => e.preventDefault()} onClick={formatQuote}>
        <span className="icon quote" />
        <span className="text">Quote</span>
        {blockType === 'quote' && <span className="active" />}
      </button>
      <button className="item" onMouseDown={(e) => e.preventDefault()} onClick={formatCode}>
...
export default function ToolbarPlugin({ pluginType = 'default' }: ToolbarPluginProps): JSX.Element {
  ...
  const blockTypeLabel = BLOCK_TYPE_TO_BLOCK_NAME[blockType as BlockType] ?? blockType
