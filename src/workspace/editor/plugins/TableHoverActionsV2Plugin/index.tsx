  ...
  useEffect(() => {
    ...
    return editor.registerRootListener((rootElement) => {
      if (rootElement) {
        ...
        return () => rootElement.removeEventListener('mouseleave', handleMouseLeave)
      }
      return undefined
    })
  }, [editor])
    ...
    const registerDropTarget = (cell: HTMLTableCellElement) =>
      dropTargetForElements({
        ...
        onDrag: ({ location, source }) => {
          ...
          const boundaryIndex = getBoundaryIndex(cell, location.current.input.clientX)
        ...
        onDrop: ({ location, source }) => {
          ...
          editor.update(() => {
            ...
            const finishIndex = clampedBoundary > startIndex ? clampedBoundary - 1 : clampedBoundary
...
export default function TableHoverActionsV2Plugin({
  ...
  return isEditable
    ? createPortal(<TableHoverActionsV2 anchorElem={anchorElem} />, document.body)
    : null
}
