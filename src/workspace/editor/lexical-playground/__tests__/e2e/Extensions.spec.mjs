...
import { moveToEditorBeginning, moveToEditorEnd } from '../keyboardShortcuts/index.mjs'
import {
  assertHTML,
  assertSelection,
  evaluate,
...
test.describe('Extensions', () => {
  ...
  test('document.execCommand("insertText") with all text backward selection', async ({ page }) => {
    await focusEditor(page)
  ...
  test('document.execCommand("insertText") with all text forward selection', async ({ page }) => {
    await focusEditor(page)
