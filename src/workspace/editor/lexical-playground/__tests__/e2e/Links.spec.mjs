...
test.describe.parallel('Links', () => {
  ...
  test(`Can convert a text node into a link`, async ({ page }) => {
    ...
    await assertHTML(
      ...
      html`
        <p class="PlaygroundEditorTheme__paragraph" dir="auto">
          <a class="PlaygroundEditorTheme__link" href="https://facebook.com" rel="noreferrer">
            <span data-lexical-text="true">Hello</span>
          </a>
        </p>
      `
...
>
  ...
  test('Can handle pressing Enter inside a Link', { tag: '@flaky' }, async ({ page }) => {
    await focusEditor(page)
  ...
  test('Can add, edit and remove links on images', async ({ page, isCollab, browserName }) => {
    // Skip for collaborative mode and Firefox on Linux
    test.skip(isCollab || (browserName === 'firefox' && process.platform === 'linux'))
    await focusEditor(page)
    ...
    await assertHTML(
      ...
      html`
        <p class="PlaygroundEditorTheme__paragraph" dir="auto">
          <a class="PlaygroundEditorTheme__link" href="https://lexical.dev" rel="noreferrer">
  ...
  test('Can add attributes with paste', async ({
    ...
    if (browserName === 'chromium') {
      ...
      await withExclusiveClipboardAccess(async () => {
        ...
        await page.evaluate(() => navigator.clipboard.writeText('https://facebook.com'))
        await paste(page)
      })
      await assertHTML(
        page,
