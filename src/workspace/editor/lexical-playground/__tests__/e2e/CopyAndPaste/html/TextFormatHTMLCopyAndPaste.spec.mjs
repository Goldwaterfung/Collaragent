...
test.describe('HTML CopyAndPaste', () => {
  ...
  test('Copy + paste html with highlight formatting', async ({ page, isPlainText }) => {
    test.skip(isPlainText)
    await focusEditor(page)
    const clipboardData = {
    ...
    await assertHTML(
      ...
      html`
        <p class="PlaygroundEditorTheme__paragraph" dir="auto">
          ...
          <mark data-lexical-text="true">
            <strong class="PlaygroundEditorTheme__textBold PlaygroundEditorTheme__textHighlight">
              Bold&amp;Highlight
            </strong>
          </mark>
        </p>
