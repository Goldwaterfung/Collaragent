...
test.describe('HTML Links CopyAndPaste', () => {
  ...
  test('Copy + paste empty link #3193', async ({ page, isPlainText }) => {
    ...
    await assertHTML(
      page,
      html`
        <p class="PlaygroundEditorTheme__paragraph" dir="auto" style="text-align: left">
          <span data-lexical-text="true">Line 0</span>
        </p>
        <ul class="PlaygroundEditorTheme__ul" dir="auto">
          <li class="PlaygroundEditorTheme__listItem" style="text-align: left" value="1">
          ...
          <li class="PlaygroundEditorTheme__listItem" style="text-align: left" value="2">
