...
test.describe('HTML Tables CopyAndPaste', () => {
      ...
      html`
        <table class="PlaygroundEditorTheme__table" dir="auto">
          ...
          <tr>
            <td class="PlaygroundEditorTheme__tableCell">
              <p class="PlaygroundEditorTheme__paragraph">
                <span style="font-size: 11pt" data-lexical-text="true"> short </span>
              </p>
            </td>
            <td class="PlaygroundEditorTheme__tableCell">
              <p class="PlaygroundEditorTheme__paragraph">
            ...
            <td class="PlaygroundEditorTheme__tableCell">
              <p class="PlaygroundEditorTheme__paragraph">
                <span style="font-size: 11pt" data-lexical-text="true"> default </span>
              </p>
            </td>
          </tr>
          <tr>
      ...
      html`
        <table class="PlaygroundEditorTheme__table" dir="auto">
          ...
          <tr style="height: 21px">
            <td class="PlaygroundEditorTheme__tableCell" style="vertical-align: bottom">
              <p class="PlaygroundEditorTheme__paragraph">
                <span data-lexical-text="true">a</span>
              </p>
            </td>
  ...
  test('Copy + paste - Merge Grids', async ({ page, isPlainText, isCollab }) => {
    test.skip(isPlainText)
    test.fixme(isCollab, 'Table selection styles are not properly selected/deselected')
  ...
  test('Copy + paste table with empty row', async ({ page, isPlainText, isCollab }) => {
    test.skip(isPlainText)
