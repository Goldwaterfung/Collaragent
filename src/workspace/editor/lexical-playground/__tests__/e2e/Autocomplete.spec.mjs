...
test.describe('Autocomplete', () => {
  ...
  test('Can autocomplete a word', { tag: '@flaky' }, async ({ page, isPlainText }) => {
    ...
    await assertHTML(
      ...
      html`
        <p class="PlaygroundEditorTheme__paragraph" dir="auto">
          <span data-lexical-text="true">Sort by alpha</span>
          <span style="font-size: 15px" data-lexical-text="true"> betical order: </span>
        </p>
      `
    )
  })
  ...
  test('Undo does not cause an exception', async ({ page, isPlainText, isCollab }) => {
    test.skip(isPlainText)
