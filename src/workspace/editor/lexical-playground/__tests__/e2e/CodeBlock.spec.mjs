...
test.describe('CodeBlock', () => {
    ...
    if (isRichText) {
      ...
      await assertHTML(
        ...
        html`
          ...
          >
            <span class="PlaygroundEditorTheme__tokenFunction" data-lexical-text="true">
              alert
            </span>
            <span class="PlaygroundEditorTheme__tokenPunctuation" data-lexical-text="true">
              (
            </span>
  ...
  test('Can select partial paragraphs and convert to code block', async ({ page, isPlainText }) => {
    test.skip(isPlainText)
    await focusEditor(page)
    await page.keyboard.type('foo')
    await page.keyboard.press('Enter')
    ...
    await assertHTML(
      ...
      html`
        ...
        >
          ...
          <span class="PlaygroundEditorTheme__tokenPunctuation" data-lexical-text="true"> . </span>
          <span class="PlaygroundEditorTheme__tokenFunction" data-lexical-text="true"> log </span>
          <span class="PlaygroundEditorTheme__tokenPunctuation" data-lexical-text="true"> ( </span>
    ...
    await assertHTML(
      ...
      html`
        ...
        >
          ...
          <span class="PlaygroundEditorTheme__tokenPunctuation" data-lexical-text="true"> ; </span>
          <span data-lexical-text="true"></span>
          <span class="PlaygroundEditorTheme__tokenComment" data-lexical-text="true"> // end </span>
        </code>
      `
    )
  ...
  test('Can create code block with language `diff`', async ({ page, isRichText }) => {
    await focusEditor(page)
    await page.keyboard.type('```diff >let a = 1;\n<let b = 2;\nlet c = 3;\n let d = 4;')
    if (isRichText) {
      await assertHTML(
        page,
        html`
          <code
            ...
            data-language="diff"
          >
            <span class="PlaygroundEditorTheme__tokenInserted" data-lexical-text="true">
              &gt;
            </span>
            <span data-lexical-text="true">let a = 1;</span>
            <br />
            <span class="PlaygroundEditorTheme__tokenDeleted" data-lexical-text="true"> &lt; </span>
            <span data-lexical-text="true">let b = 2;</span>
            <br />
            <span data-lexical-text="true">let c = 3;</span>
            <br />
            <span class="PlaygroundEditorTheme__tokenUnchanged" data-lexical-text="true"></span>
  ...
  test('Can create code block with language `diff-javascript`', async ({ page, isRichText }) => {
    await focusEditor(page)
    await page.keyboard.type('```diff-javascript +let a = 1;\n-let b = 2;\nlet c = 3;\n let d = 4;')
    if (isRichText) {
      await assertHTML(
        page,
        html`
          ...
          >
            <span class="PlaygroundEditorTheme__tokenInserted" data-lexical-text="true"> + </span>
            <span class="PlaygroundEditorTheme__tokenAttr" data-lexical-text="true"> let </span>
            ...
            <span class="PlaygroundEditorTheme__tokenOperator" data-lexical-text="true"> = </span>
            <span data-lexical-text="true"></span>
            <span class="PlaygroundEditorTheme__tokenProperty" data-lexical-text="true"> 4 </span>
            <span class="PlaygroundEditorTheme__tokenPunctuation" data-lexical-text="true">
              ;
            </span>
          </code>
      ...
      await assertHTML(
        ...
        html`
          <p class="PlaygroundEditorTheme__paragraph" dir="auto">
            <span data-lexical-text="true"> \`\`\`diff-javascript +let a = 1; </span>
            <br />
            <span data-lexical-text="true">-let b = 2;</span>
            <br />
            <span data-lexical-text="true">let c = 3;</span>
