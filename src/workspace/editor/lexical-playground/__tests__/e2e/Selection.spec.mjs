...
test.describe.parallel('Selection', () => {
  ...
  test('can delete text by line backwards with CMD+delete', async ({ page, isPlainText }) => {
    ...
    const lines = (...args) => html` ${args.map(p).join('')} `
  ...
  test('can delete text by line forwards with opt+CMD+delete', async ({ page, isPlainText }) => {
    test.skip(isPlainText || !IS_MAC)
    await focusEditor(page)
    await page.keyboard.type('One')
    await page.keyboard.press('Enter')
  ...
  test('can delete text by line forwards with control+K', async ({ page, isPlainText }) => {
  ...
  test('can delete line which starts with element forwards with opt+CMD+delete', async ({
    ...
    const modifyImageHTML = async (originalHtml) =>
      await prettifyHTML(
        originalHtml
          .replace(/<button\s+class="image-edit-button">\s*Edit\s*<\/button>/gi, '')
  ...
  test(`Can't delete forward a Collapsible`, async ({ page, browserName, isPlainText }) => {
    test.skip(isPlainText)
    if (!IS_MAC) {
  ...
  test(`Can't delete backward a Collapsible`, async ({ page, browserName, isPlainText }) => {
    test.skip(isPlainText)
    if (!IS_MAC) {
      // Do Windows/Linux have equivalent shortcuts?
      return
  ...
  test('Can adjust triple click selection', async ({ page, isPlainText, isCollab }) => {
  ...
  test('Can adjust triple click selection with', async ({ page, isPlainText, isCollab }) => {
    test.skip(isPlainText || isCollab)
  ...
  test('Select all (DecoratorNode at start) #4670', async ({ page, isPlainText }) => {
    // TODO selectAll is bad for Linux #4665
    test.skip(isPlainText || IS_LINUX)
  ...
  test('Select next with RTL (DecoratorNode) #7685', async ({ page, isPlainText, isCollab }) => {
    test.skip(isPlainText || isCollab)
    await page.keyboard.type('קצת מלל')
    await insertHorizontalRule(page)
    await page.keyboard.type('עוד')
  ...
  test('Move left from DecoratorNode in RTL #7771', async ({ page, isPlainText, isCollab }) => {
    test.skip(isPlainText || isCollab)
    ...
    const expectedSelection = createHumanReadableSelection('just after the datetime', {
  ...
  test('Move right from DecoratorNode in RTL #7771', async ({ page, isPlainText, isCollab }) => {
    test.skip(isPlainText || isCollab)
    await page.keyboard.type('קצת')
    await insertDateTime(page)
    await page.keyboard.type('קצת')
    ...
    const expectedSelection = createHumanReadableSelection('just before the datetime', {
  ...
  test('Move right from last node in RTL #7775', async ({ page, isPlainText, isCollab }) => {
    test.skip(isPlainText || isCollab)
    await page.keyboard.type('קצת')
    await insertDateTime(page)
  ...
  test('Move left from last node in RTL #7775', async ({
    ...
    const expectedSelection = createHumanReadableSelection('at end of paragraph', {
  ...
  test('Triple-clicking last cell in table should not select entire document', async ({
    ...
    const lastCell = page.locator('.PlaygroundEditorTheme__tableCell:last-child')
  ...
  test('Can persist the text format from the paragraph', async ({ page, isPlainText }) => {
    test.skip(isPlainText)
    await focusEditor(page)
    await pressToggleBold(page)
    await page.keyboard.type('Line1')
    ...
    await assertHTML(
      ...
      html`
        <p class="PlaygroundEditorTheme__paragraph" dir="auto">
          <strong class="PlaygroundEditorTheme__textBold" data-lexical-text="true"> Line1 </strong>
        </p>
        <p class="PlaygroundEditorTheme__paragraph" dir="auto"><br /></p>
        <p class="PlaygroundEditorTheme__paragraph" dir="auto">
          <strong class="PlaygroundEditorTheme__textBold" data-lexical-text="true"> Line3 </strong>
        </p>
        <p class="PlaygroundEditorTheme__paragraph" dir="auto">
          <strong class="PlaygroundEditorTheme__textBold" data-lexical-text="true"> Line2 </strong>
        </p>
      `
    )
  })
  ...
  test('Can persist the text style (color) from the paragraph', async ({ page, isPlainText }) => {
    test.skip(isPlainText)
    await focusEditor(page)
    ...
    await assertHTML(
      ...
      html`
        <p class="PlaygroundEditorTheme__paragraph" dir="auto">
          <span style="color: rgb(208, 2, 27)" data-lexical-text="true"> Line1 </span>
        </p>
        <p class="PlaygroundEditorTheme__paragraph" dir="auto"><br /></p>
        <p class="PlaygroundEditorTheme__paragraph" dir="auto">
          <span style="color: rgb(208, 2, 27)" data-lexical-text="true"> Line3 </span>
        </p>
        <p class="PlaygroundEditorTheme__paragraph" dir="auto">
          <span style="color: rgb(208, 2, 27)" data-lexical-text="true"> Line2 </span>
        </p>
      `
    )
  })
  ...
  test('programatic update on blurred editor does not kill selection', async ({
    ...
    await page.evaluate(() => {
      const editor = document.querySelector('div[contenteditable="true"]').__lexicalEditor
