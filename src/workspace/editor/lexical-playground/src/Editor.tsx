...
import { SelectionAlwaysOnDisplayExtension, type Signal } from '@lexical/extension'
import { ClickableLinkExtension, LinkAttributes, LinkExtension } from '@lexical/link'
...
export default function Editor(): JSX.Element {
  ...
  useSyncExtensionSignal(SelectionAlwaysOnDisplayExtension, 'disabled', !selectionAlwaysOnDisplay)
