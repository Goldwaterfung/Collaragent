...
9. **Focus State Management**: Remove default browser focus rings using `focus:outline-none` and avoid generic `focus:ring` utility classes. Prefer custom, component-specific focus indicators that align with the design system.
