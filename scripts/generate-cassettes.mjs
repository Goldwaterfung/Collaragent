...
const standardDocumentPayload = {
  blocks: [
    { id: 'blk-h1-01', type: 'h1', content: 'Quantum Computing Foundations' },
    {
      id: 'blk-p-01',
      type: 'paragraph',
      content: 'Introductory section exploring basic principles.'
    },
    ...
    },
    {
      ...
      tableRows: [
        {
          cells: [
            { children: [{ text: 'Qubit Type' }] },
            { children: [{ text: 'Coherence Time' }] },
            { children: [{ text: 'Fidelity' }] }
          ]
        },
        {
          cells: [
            { children: [{ text: 'Superconducting' }] },
            { children: [{ text: '100 us' }] },
            { children: [{ text: '99.9%' }] }
          ]
        },
        {
          cells: [
            { children: [{ text: 'Trapped Ion' }] },
            { children: [{ text: '10 s' }] },
            { children: [{ text: '99.99%' }] }
          ]
        }
...
const standardGraphCanvas = {
  ...
  graph: {
    ...
    relationships: {
      'rel-1': {
        id: 'rel-1',
        from: { nodeId: 'node-root-1', portId: 'out' },
        to: { nodeId: 'node-cft-1', portId: 'in' }
      },
      'rel-2': {
        id: 'rel-2',
        from: { nodeId: 'node-root-1', portId: 'out' },
        to: { nodeId: 'node-bft-1', portId: 'in' }
      },
      'rel-3': {
        id: 'rel-3',
        from: { nodeId: 'node-cft-1', portId: 'out' },
        to: { nodeId: 'node-raft-1', portId: 'in' }
      },
      'rel-4': {
        id: 'rel-4',
        from: { nodeId: 'node-cft-1', portId: 'out' },
        to: { nodeId: 'node-paxos-1', portId: 'in' }
      }
    }
  },
  layout: {
...
const scenarios = [
  ...
  { id: 'SCN-GRP-05', tool: 'linkNodes', graph: standardGraphCanvas },
  {
    id: 'SCN-GRP-06',
    tool: 'linkDocToNode',
    graph: standardGraphCanvas,
    doc: standardDocumentPayload
  },
